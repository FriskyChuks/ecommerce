# Generated by Django 4.2.1 on 2023-06-13 13:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxPrice', models.DecimalField(decimal_places=2, default=0.0, max_digits=7)),
                ('shippingPrice', models.DecimalField(decimal_places=2, default=0.0, max_digits=7)),
                ('totalPrice', models.DecimalField(decimal_places=2, default=0.0, max_digits=7)),
                ('isPaid', models.DateTimeField(blank=True, null=True)),
